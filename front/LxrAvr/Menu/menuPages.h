...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	...
	// MENU_MIDI_PAGE - hold shift and load/save. do it again to access 5-8, and again to access others
	{
		...
		{ // -- AS GMENU 2nd sub page of global settings
			...
			/* MIDI roll-note offset belongs with global MIDI/settings controls,
			   separate from the performance roll rate/note/velocity/mode page. */
			TEXT_BUT_SHIFT_MODE, TEXT_FILE_LOAD_BACKGROUND, TEXT_OSC_WAVE_INTERPOLATION, TEXT_ROLL_NOTE_OFFSET, TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_BUT_SHIFT_MODE, PAR_FILE_LOAD_BACKGROUND,  PAR_OSC_WAVE_INTERPOLATION, PAR_ROLL_NOTE_OFFSET, PAR_NONE,  PAR_NONE,PAR_NONE,PAR_NONE
		},{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
	...
	//there is only one page with subpages shown for the whole mode
	{
		...
		{		
		TEXT_SHUFFLE,	TEXT_ROLL_SPEED,	TEXT_ROLL_NOTE,	TEXT_ROLL_VELOCITY,   TEXT_SAMPLE_RATE,         TEXT_X_FADE, TEXT_MORPH_DRUM1, TEXT_MORPH_DRUM2, 
		PAR_SHUFFLE,	PAR_ROLL,         PAR_ROLL_NOTE,	   PAR_ROLL_VELOCITY, PAR_VOICE_DECIMATION_ALL, PAR_MORPH,   PAR_MORPH_DRUM1,   PAR_MORPH_DRUM2
		},{		
			TEXT_MORPH_DRUM3, TEXT_MORPH_SNARE, TEXT_MORPH_CYM, TEXT_MORPH_HIHAT, TEXT_EMPTY, TEXT_EMPTY, TEXT_EMPTY, TEXT_EMPTY,
			PAR_MORPH_DRUM3,  PAR_MORPH_SNARE,  PAR_MORPH_CYM,  PAR_MORPH_HIHAT,   PAR_NONE,   PAR_NONE,   PAR_NONE,   PAR_NONE
		},{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
