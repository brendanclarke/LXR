...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	...
	// MENU_MIDI_PAGE - hold shift and load/save. do it again to access 5-8, and again to access others
	{
		...
		{ // -- AS GMENU 2nd sub page of global settings
			TEXT_SCREENSAVER_ON_OFF, TEXT_BAR_RESET_MODE, TEXT_SEQ_PC_TIME, TEXT_TRIGGER_IN_PPQ, TEXT_TRIGGER_OUT1_PPQ,TEXT_TRIGGER_OUT2_PPQ,TEXT_TRIGGER_GATE_MODE,TEXT_EMPTY,
			PAR_SCREENSAVER_ON_OFF,  PAR_BAR_RESET_MODE, PAR_SEQ_PC_TIME, PAR_PRESCALER_CLOCK_IN, PAR_PRESCALER_CLOCK_OUT1,PAR_PRESCALER_CLOCK_OUT2,	PAR_TRIG_GATE_MODE,	PAR_NONE
