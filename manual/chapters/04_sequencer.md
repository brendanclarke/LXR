...
### Automation-Only Steps

If the **velocity** of a step is set to 0, The envelopes for the voice will not be retriggered by that
step. However, all other parameters of the step will still be processed. This is useful for changing
the sound parameters of a voice as it decays or automating changing to other voices, for example. 
