...
**Current working source**: repository root, branch `dev-samples`.
...
**Current consolidation / protocol planning artifacts**: the durable finalization notes now live in `knowledge_files/log_archive/031_SESSION_HANDOFF_LOG.md`, `knowledge_files/log_archive/030_SESSION_HANDOFF_LOG.md`, `knowledge_files/log_archive/029_SESSION_HANDOFF_LOG.md`, `knowledge_files/log_archive/028_SESSION_HANDOFF_LOG.md`, `knowledge_files/log_archive/027_SESSION_HANDOFF_LOG.md`, `knowledge_files/log_archive/026_SESSION_HANDOFF_LOG.ms`, `knowledge_files/log_archive/025_SESSION_HANDOFF_LOG.md`, `knowledge_files/log_archive/024_SESSION_HANDOFF_LOG.md`, `knowledge_files/log_archive/023_SESSION_HANDOFF_LOG.md`, `knowledge_files/log_archive/021_SESSION_HANDOFF_LOG.md`, `knowledge_files/log_archive/020_SESSION_HANDOFF_LOG.md`, `knowledge_files/comms_spec_reference/COMMS_FLOW_SPEC.md`, `knowledge_files/comms_spec_reference/BACKGROUND_LOAD_TEMPORARY.md`, and `knowledge_files/comms_spec_reference/MIDI_TABLE.md`. Current sample-import behavior lives in `knowledge_files/log_archive/031_SESSION_HANDOFF_LOG.md` and `knowledge_files/comms_spec_reference/COMMS_FLOW_SPEC.md`; `SAMPLE_LOAD_REDO_AUDIT.md` is superseded and can be deleted after this closeout. Root files `SAMPLE_PLAN_PHASE_1.md`, `SAMPLE_PLAN_PHASE_1_POST_BUGS.md`, `SAMPLE_PLAN_PHASE_2.md`, `SAMPLE_PLAN_PHASE_3.md`, `SAMPLE_PLAN_PHASE_3_AUDIT_INVESTIGATION_1.md`, `SAMPLE_PLAN_PHASE_3_AUDIT_INVESTIGATION_2.md`, and `PHASE_3_CORRECTIONS_PART_2.md` were temporary Session 030 planning/debug docs and can be deleted if still present. Current background-load behavior lives in `knowledge_files/log_archive/028_SESSION_HANDOFF_LOG.md`, `knowledge_files/comms_spec_reference/COMMS_FLOW_SPEC.md`, and `knowledge_files/comms_spec_reference/BACKGROUND_LOAD_TEMPORARY.md`. Current external MIDI behavior lives in `knowledge_files/log_archive/029_SESSION_HANDOFF_LOG.md` and `knowledge_files/comms_spec_reference/MIDI_TABLE.md`; root files `GLOBAL_MIDI_AUDIT.md`, `GLOBAL_MIDI_TABLE_REQUEST.md`, and `GLOBAL_MIDI_TABLE_TO_CREATE.md` are temporary Session 029 planning docs and can be deleted after this closeout. The temporary root audits `TEMP_LOAD_MENU_AUDIT.md`, `TEMP_LOAD_ACK_AUDIT.md`, `FILE_LOAD_SWAP_PART2_AUDIT.md`, `FILE_LOAD_MORPH_CHANGE_BUG_AUDIT.md`, `BG_LOAD_SWITCH_AUDIT.md`, `AUDIT_PER_VOICE_MORPH_PAT_BG_TWEAKS.md`, `AUDIT_BG_LOAD_TWEAKS2.md`, and `AUDIT_BG_LOAD_LED_HINT.md` can be deleted after Session 028 closeout. Current encoder hardware details live in `knowledge_files/log_archive/019_SESSION_HANDOFF_LOG.md` and supersede the temporary `ENCODER_AUDIT.md`; the resolved encoder `DTYPE_MENU` value-domain fix lives in `knowledge_files/log_archive/027_SESSION_HANDOFF_LOG.md`. `AUDIT_LIVE_REC_WRONG_PARAMS.md` and `ENC_DTYPE_MENU_WRONG.md` were temporary Session 027 working docs and can be deleted after this closeout. `VOICE_MORPH_CONTROLS_AUDIT2.md` was the temporary working doc for Session 026 and can be deleted after the closeout pass if the archived handoff is sufficient. `OPCODE_AUDIT.md` was the temporary working doc for Session 024 and was removed after the handoff. `REFACTOR_FINALIZATION.md`, `REFACTOR_MY_MESS_CLEANUP.md`, `PRESET_CONSOLIDATION_AUDIT.md`, and `MIDI_UART_SPLIT_AUDIT_EDIT.md` were temporary working docs and may be deleted after Session 020.
...
- `knowledge_files/log_archive/026_SESSION_HANDOFF_LOG.ms`
...
| Current PERF voice morph behavior | `knowledge_files/log_archive/026_SESSION_HANDOFF_LOG.ms`, `VOICE_MORPH_CONTROLS_AUDIT2.md`, `knowledge_files/comms_spec_reference/COMMS_FLOW_SPEC.md` |
...
| Current background `.pat` / `.prf` / `.all` loading via temporary data | `knowledge_files/log_archive/028_SESSION_HANDOFF_LOG.md`, `knowledge_files/comms_spec_reference/COMMS_FLOW_SPEC.md`, `knowledge_files/comms_spec_reference/BACKGROUND_LOAD_TEMPORARY.md` |
