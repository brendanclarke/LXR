...
- Imported `PAR_VOICE_DECIMATION_ALL` must never survive as `0`; clamp it to `127` at the AVR file-import boundary and keep the startup default at `127`.
