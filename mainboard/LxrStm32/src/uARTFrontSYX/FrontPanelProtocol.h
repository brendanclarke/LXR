 ...
 *
 * Front-panel protocol opcodes and session constants owned by the
 * uARTFrontSYX layer. MidiMessages.h keeps a compatibility include while the
 * opcode namespace migrates here.
 */

#ifndef UARTFRONTSYX_FRONTPANELPROTOCOL_H_
#define UARTFRONTSYX_FRONTPANELPROTOCOL_H_
...
#endif /* UARTFRONTSYX_FRONTPANELPROTOCOL_H_ */
